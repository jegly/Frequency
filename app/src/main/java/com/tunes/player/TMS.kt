...
class TMS : MediaBrowserService(), PlaybackManager.PlaybackServiceCallback {
    ...
    companion object {
        ...
        const val ACTION_PLAY = "com.tunes.player.ACTION_PLAY"
        const val ACTION_PAUSE = "com.tunes.player.ACTION_PAUSE"
        const val ACTION_STOP = "com.tunes.player.ACTION_STOP"
        const val ACTION_NEXT = "com.tunes.player.ACTION_NEXT"
        const val ACTION_PREV = "com.tunes.player.ACTION_PREV"
    }
    ...
    private fun createStartupChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (nm.getNotificationChannel(CHANNEL_ID) == null) {
                val channel = NotificationChannel(CHANNEL_ID, "Tunes Service", NotificationManager.IMPORTANCE_LOW)
