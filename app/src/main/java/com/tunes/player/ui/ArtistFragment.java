...
public class ArtistFragment extends Fragment implements ItemClickListener.SingleEvent {
    ...
    private void setRv(View view) {
        if (null != getActivity()) new ArtistFetcher(getActivity().getContentResolver(), list -> {
            if (null != list && list.size() > 0) {
                ...
                adapter = new ArtistAdapter(list, getLayoutInflater(), this);
